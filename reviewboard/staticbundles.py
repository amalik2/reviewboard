...
PIPELINE_JAVASCRIPT = dict({
    ...
    '3rdparty': {
        'source_filenames': (
            ...
            'lib/js/wavesurferjs-3.2.0.min.js',
            'lib/js/wavesurferjs-spectrogram-3.2.0.min.js',
            'lib/js/wavesurferjs-timeline-3.2.0.min.js',
            'lib/js/wavesurferjs-regions-3.2.0.min.js',
        ),
    ...
    'js-tests': {
        'source_filenames': (
            ...
            'rb/js/views/tests/audioPlayerViewTests.es6.js',
            'rb/js/views/tests/audioReviewableViewTests.es6.js',
        ),
    ...
    'common': {
        'source_filenames': (
            ...
            'rb/js/resources/utils/audioSpectrogramHotmapDecorator.es6.js',
    ...
    'reviews': {
        'source_filenames': (
            ...
            'rb/js/models/audioPlayerModel.es6.js',
            'rb/js/models/audioCommentBlockModel.es6.js',
            'rb/js/models/audioReviewableModel.es6.js',
            ...
            'rb/js/views/audioCommentBlockView.es6.js',
            'rb/js/views/audioPlayerView.es6.js',
            'rb/js/views/audioReviewableView.es6.js',
...
PIPELINE_STYLESHEETS = dict({
    ...
    'reviews': {
        'source_filenames': (
            ...
            'rb/css/pages/audio-review-ui.less',
